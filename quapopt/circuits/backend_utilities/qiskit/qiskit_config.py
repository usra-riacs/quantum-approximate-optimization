...
from quapopt.circuits.backend_utilities.qiskit.check_backends import (
...
DEFAULT_SIMULATED_SAMPLER_KWARGS = {
...
DEFAULT_SIMULATOR_BACKEND_KWARGS = {
    **{"device": DEFAULT_DEVICE_SIMULATOR_QISKIT, "method": "statevector"},
