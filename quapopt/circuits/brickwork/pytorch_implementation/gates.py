...
def get_1q_unitary(
    ...
    if gate_descriptor.gate_type == GateType1q.RZ:
        ...
        gate_1q[0, 1], gate_1q[1, 0] = torch.exp(-1j * angles[0]), torch.exp(
            1j * angles[0]
        )
...
def get_2q_unitary(
    angles: torch.Tensor, gate_descriptor: GateDescriptor, device: torch.device
) -> torch.Tensor:
    """
    ...
    if gate_descriptor.gate_type == GateType2q.RZZ:
        ...
        gate_2q[0, 0], gate_2q[1, 1], gate_2q[2, 2], gate_2q[3, 3] = (
            el_diagonal,
            el_diagonal,
            el_diagonal,
            el_diagonal,
        )
        gate_2q[0, 3], gate_2q[1, 2], gate_2q[2, 1], gate_2q[3, 0] = (
            el_03,
            el_12,
            el_21,
            el_30,
