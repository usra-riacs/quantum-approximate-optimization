    ...
    def generate_instance(
        ...
        hamiltonian_instance_specifier = (
            hamiltonian_class_specifier.instance_specifier_constructor(
                number_of_qubits, seed, graph_degree
            )
        )
        ...
        random_graph_structure = nx.random_regular_graph(
            d=graph_degree, n=number_of_qubits, seed=seed
        )
...
if __name__ == "__main__":
    generator = RandomRegularHamiltonianGenerator(
        number_of_qubits=10,
